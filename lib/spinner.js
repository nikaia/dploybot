/*
 |--------------------------------------------------------------------------
 | Modification version of cli-spinner package.
 | Need to add padding before displaying spinner
 |--------------------------------------------------------------------------
 */
...
var Spinner = function(textToShow, prefix){
  this.prefix = prefix || '';
...
Spinner.prototype.start = function() {
  ...
  this.id = setInterval(function() {
    ...
    clearLine();
    process.stdout.write(clc.blue(self.prefix + msg));
